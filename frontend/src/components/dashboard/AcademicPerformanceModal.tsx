...
export const AcademicPerformanceModal: React.FC<AcademicPerformanceModalProps> = ({
  open,
  onOpenChange,
  selectedChild
}) => {
  ...
  // Filter evaluations for selected discipline
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-xl">
            ...
            Rendimiento Académico - {selectedChild.nino_nombre}
          </DialogTitle>
        </DialogHeader>
